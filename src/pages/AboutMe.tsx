  ...
  return (
    <section id="about" className="min-h-screen py-12 mt-16">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="max-w-6xl mx-auto my-16 grid grid-cols-2 gap-24">
          ...
          <div className="flex col-span-1 flex-col gap-8">
            <div>
              <p className="leading-relaxed">
                ...
                developing my skills and building web applications. My aim is always to strip away unnecessary complexityy – if a user has to think twice about how something works, or if it's nothing I've 
